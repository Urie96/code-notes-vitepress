...
const mermaid2HTML = (code) => {
  ...
  try {
    ...
    return url2html(`https://mermaid.ink/svg/${darkPayload}`, 'only-dark') +
...
const plant2HTML = (code) => {
  ...
  return url2html(`https://www.plantuml.com/plantuml/svg/${zippedCode}`, 'uml only-light') +
    url2html(`https://www.plantuml.com/plantuml/dsvg/${zippedCode}`, 'uml only-dark')
}
